                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active" href="#">Books</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            %>
                                                <tr scope="row">
                                                    ...
                                                    <td style="text-align: right;padding-right: 50px;">
                                                        <form action="RemoveBookAdmin" method="post">
                                                            <a style="font-color: #df2359" href="<%=request.getContextPath()%>/RemoveBookAdmin?removebookadmin=<%=b.getId() %>"><i class="fa fa-solid fa-check"></i></a>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <tr class="spacer">
