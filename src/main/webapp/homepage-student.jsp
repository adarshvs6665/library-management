...
<%@ page import="com.library.bookOperations.MyBooks" %>
<!DOCTYPE html>
...
<body>
                ...
                <span class="toggler-icon"></span>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a class="page-scroll-new page-scroll active" href="#student-home">Student Home</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <!-- ======== hero-section start ======== -->
    <section id="student-home" class="hero-section">
        <div class="container">
