...
<%@page import="com.library.bean.student.Student"%>
<%@page import="com.library.studentOperations.RemoveStudent"%>
...
<body>
    <script>
		removeStudentLoaded();
		function removeStudentLoaded() {
			<%
				int flag;
				if(session.getAttribute("removeStudentStatus") == "failed") {
					session.setAttribute("removeStudentStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int removeStudentStatusFlag;
				if(session.getAttribute("removeStudentStatus") == "success") {
					session.setAttribute("removeStudentStatus","");
					removeStudentStatusFlag = 1;
				} else {
					removeStudentStatusFlag = 0;
				}
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active" href="#">Students</a>
                                    </li>
                                        ...
                                        <table id="myTable" class="table custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table-heading" scope="col">Age</th>
                                                    <th class="table-heading" scope="col">Dept.</th>
                                                    <th class="table-heading" scope="col">Email</th>
                                                    <th class="table-heading" scope="col">Joining Date</th>
                                                    <th class="table-heading" scope="col">Fine</th>
                                                    <th class="table-heading" scope="col">Remove</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <% 
                                            	List<Student> studentList = (List<Student>)request.getAttribute("studentList1");
	                                            String id = null;
                                            ...
                                            %>
                                                <tr scope="row">
                                                    ...
                                                    <td><%=st.getDept() %></td>
                                                    <td><%=st.getEmail() %></td>
                                                    <td><%=st.getJoining_date() %></td>
                                                    <td><%=st.getFine() %></td>
                                                    <td style="text-align: right;padding-right: 60px;">
                                                        <form action="RemoveStudent" method="post">
                                                            <a style="font-color: #df2359" href="<%=request.getContextPath()%>/RemoveStudentAdmin?removestudentadmin=<%=st.getId() %>"><i class="fa fa-solid fa-check"></i></a>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <tr class="spacer">
