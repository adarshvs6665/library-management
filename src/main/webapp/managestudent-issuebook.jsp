...
<%@page import="com.library.bookOperations.IssueBook" %>
<!DOCTYPE html>
...
<body>
	<script>
	issueBookPageLoaded();
		function issueBookPageLoaded() {
			<%
				int flag;
				if(session.getAttribute("issueBookStatus") == "failed") {
					session.setAttribute("issueBookStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int issueBookSuccessFlag;
				if(session.getAttribute("issueBookStatus") == "success") {
					session.setAttribute("issueBookStatus","");
					issueBookSuccessFlag = 1;
				} else {
					issueBookSuccessFlag = 0;
				}
				
			%>
			if(<%=flag%> == 0) {
				alert("Book or Student doesn't exist / Book not available");
			}
			if(<%=issueBookSuccessFlag%> == 1) {
                        ...
                        <div class="limiter">
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    ...
                                    <form method="post" action="IssueBook" class="login100-form validate-form">
                                  ...
                                  Issue Book
                                        ...
                                        <div class="wrap-input100">
                                            <input class="input100" type="text" name="student_id" placeholder="Enter Student ID" required>
                                            <span class="focus-input100"></span>
                                            <span class="symbol-input100">
                                        ...
                                        <div class="wrap-input100">
                                            <input class="input100" type="email" name="student-email" placeholder="Enter Student Email" required>
                                            <span class="focus-input100"></span>
                                            <span class="symbol-input100">
                                        ...
                                        <div class="container-login100-form-btn">
                                            <input type="submit" value="ISSUE BOOK" class="login100-form-btn">
