...
<%
	     ...
	     if(session.getAttribute("student_login")!="success")
		    {	
...
<body>
	<script>
	reserveBookPageLoaded();
		function reserveBookPageLoaded() {
			<%
				int flag;
				if(session.getAttribute("reserveBookStatus") == "failed") {
					session.setAttribute("reserveBookStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int reserveBookSuccessFlag;
				if(session.getAttribute("reserveBookStatus") == "success") {
					session.setAttribute("reserveBookStatus","");
					reserveBookSuccessFlag = 1;
				} else {
					reserveBookSuccessFlag = 0;
				}
				
			%>
			if(<%=flag%> == 0) {
				alert("Quantity Exhausted");
			}
			if(<%=reserveBookSuccessFlag%> == 1) {
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a class="page-scroll-new page-scroll" href="homepage-student.jsp">Student
                                            Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="MyBooks">View my Books</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll active" href="#">Check Availability</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="page-scroll" href="ViewFine">View Fine</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Reservations">Reservations</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="<%=request.getContextPath()%>/StudentLogout">Logout</a>
                                    </li>
                                        ...
                                        <table id="myTable" class="table custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table-heading" scope="col">Book Name</th>
                                                    <th class="table-heading" scope="col">Author Name</th>
                                                    <th class="table-heading" scope="col">Publisher Name</th>
                                                    <th class="table-heading" scope="col">Remaining Qty</th>
                                                    <th class="table-heading" scope="col">Reserve Book</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            	<% 
                                            ...
                                            %>
                                                <tr scope="row">
                                                    ...
                                                    <td id="qty"><%=b.getRemaining() %></td>
                                                    <td style="text-align: left;padding-left: 55px;">
                                                        <form action="ReserveBook" method="post">
                                                            <a id="Link1" style="font-color: #df2359" href="<%=request.getContextPath()%>/ReserveBook?bookid=<%=b.getId() %>">
                                                            <i id="btn-tick" class="fa fa-solid fa-check"></i>
                                                             </a>
                                                        </form>
                                                    </td>
                                                    <!-- 
                                                    <script>
                                                    	...
                                                    	var remaining_qty = document.getElementById('qty').innerHTML;
                                                   ...
                                                   function disableLink()
                                                           ...
                                                           document.getElementById('Link1').href = "<%=request.getContextPath()%>/HelloServlet";
                                                           ...
                                                           const box = document.getElementById('btn-tick');

                                                        //Change text color on mouseover
                                                        box.addEventListener('mouseover', function handleMouseOver() {
                                                          box.style.color = colourcode;
                                                        });
