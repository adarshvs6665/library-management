...
<%@ page import="com.library.fineOperations.PayFine" %>
<!DOCTYPE html>
...
<script>
payFinePageLoaded();
		function payFinePageLoaded() {
			<%
				int flag;
				if(session.getAttribute("payFineStatus") == "failed") {
					session.setAttribute("payFineStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int payFineSuccessFlag;
				if(session.getAttribute("payFineStatus") == "success") {
					session.setAttribute("payFineStatus","");
					payFineSuccessFlag = 1;
				} else {
					payFineSuccessFlag = 0;
				}
                        ...
                        <div class="limiter">
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    ...
                                    <form method="post" action="PayFine" class="login100-form validate-form">
                                  ...
                                  Pay Fine
                                        ...
                                        <div class="wrap-input100">
                                            <input class="input100" type="text" name="fine_amount" placeholder="Enter Amount Paid" required>
                                            <span class="focus-input100"></span>
                                            <span class="symbol-input100">
                                        ...
                                        <div class="container-login100-form-btn">
                                            <input type="submit" value="PAY FINE" class="login100-form-btn">
                                        </div>
