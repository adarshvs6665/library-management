...
<%@page import = "com.library.bookOperations.ReturnBook" %>
<!DOCTYPE html>
...
<script>
		returnBookPageLoaded();
		function returnBookPageLoaded() {
			<%
				int flag;
				if(session.getAttribute("returnBookStatus") == "failed") {
					session.setAttribute("returnBookStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int returnBookSuccessFlag;
				if(session.getAttribute("returnBookStatus") == "success") {
					session.setAttribute("returnBookStatus","");
					returnBookSuccessFlag = 1;
				} else {
					returnBookSuccessFlag = 0;
				}
                        ...
                        <div class="limiter">
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    ...
                                    <form method="post" action="ReturnBook" class="login100-form validate-form">
                                  ...
                                  Return Book
                                        ...
                                        <div class="container-login100-form-btn">
                                            <input type="submit" value="RETURN BOOK" class="login100-form-btn">
