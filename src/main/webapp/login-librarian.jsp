...
<%@page import="com.library.credentials.LibrarianLogin"%>
<!DOCTYPE html>
                            ...
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    <div class="login100-pic js-tilt" data-tilt>
                                        <img src="images/card-bg-librarian.jpg" alt="IMG">
                                    </div>

                                    <form method="post" action="LibrarianLogin" class="login100-form validate-form">
                                        <span class="login100-form-title">
                                  Librarian Login
                                </span>

                                        <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                            <input class="input100" type="text" name="email" placeholder="Librarian Email">
