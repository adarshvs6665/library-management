                                        ...
                                        <table id="myTable" class="table custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table-heading" scope="col">Student ID</th>
                                                    <th class="table-heading" scope="col">Student Name</th>
                                            ...
                                            <tbody>
                                            <% 
                                            	List<IssuedBooks> bookList = (List<IssuedBooks>)request.getAttribute("issuedBookList");
	                                            String id = null;
	                                    		for(IssuedBooks b : bookList) { 
                                            %>
                                                <tr scope="row">
                                                    <td><%=b.getId() %></td>
                                                    <td><%=b.getBook() %></td>
