                ...
                <span class="toggler-icon"></span>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active" href="#">Fine</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
            ...
            <div style="min-height:614px;" class="row align-items-center position-relative">
                <div style="width:100%" class="col-lg-6">
                    <center>
                        <span class="title-managefine">Fine</span>
                    </center>
                    <div class="hero-content">
                        <div class="cards-list">

                            <div style="margin-right:30px" onclick="location.href='fine-imposefine.jsp';" class="card 1">
                                <div class="card_image"> <img src="images/card-bg.jpg" /> </div>
                                <div class="card_title title-white">
                                    <p style="padding-right: 0;color: #162447;font-weight: 900;font-size: 20px;">Impose Fine</p>
                                </div>
                            </div>
                            <div style="margin-left:30px" onclick="location.href='fine-payfine.jsp';" class="card 1">
                                <div class="card_image"> <img src="images/card-bg.jpg" /> </div>
                                <div class="card_title title-white">
                                    <p style="padding-right: 0;color: #162447;font-weight: 900;font-size: 20px;">Pay Fine</p>
                                </div>
                            </div>
