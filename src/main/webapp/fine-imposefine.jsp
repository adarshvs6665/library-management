...
<body>
	<script>
	imposeFinePageLoaded();
		function imposeFinePageLoaded() {
			<%
				int flag;
				if(session.getAttribute("imposeFineStatus") == "failed") {
					session.setAttribute("imposeFineStatus","");
					flag = 0;
				} else {
					flag = 1;
				}
				int imposeFineSuccessFlag;
				if(session.getAttribute("imposeFineStatus") == "success") {
					session.setAttribute("imposeFineStatus","");
					imposeFineSuccessFlag = 1;
				} else {
					imposeFineSuccessFlag = 0;
				}
                ...
                <span class="toggler-icon"></span>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active" href="homepage-librarian-fine.jsp">Fine</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="limiter">
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    ...
                                    <form method="post" action="ImposeFine" class="login100-form validate-form">
                                  ...
                                  Impose Fine
                                        ...
                                        <div class="wrap-input100">
                                            <input class="input100" type="text" name="fine_amount" placeholder="Enter Fine Amount" required>
                                            <span class="focus-input100"></span>
                                            <span class="symbol-input100">
                                        ...
                                        <div class="container-login100-form-btn">
                                            <input type="submit" value="IMPOSE FINE" class="login100-form-btn">
                                  </button>
                                        </div>
